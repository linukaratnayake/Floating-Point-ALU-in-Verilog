...
##Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { input_en }]; #IO_L19N_T3_VREF_35 Sch=SW0
...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { result_ready }]; #IO_L23P_T3_35 Sch=LED0
...
#set_property -dict { PACKAGE_PIN U20   IOSTANDARD LVCMOS33 } [get_ports { jb_p[0] }]; #IO_L15N_T2_DQS_34 Sch=JB1_N
...
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { tx }]; #IO_L18N_T2_34 Sch=JE2
